...
const content = {
  ko: {
    title: 'Bboggl 소개',
    body: [
      'Bboggl(뽀글)은 직장인의 하루 식사 고민을 덜어주는 맛집 추천 서비스입니다. 점심, 퇴근 후 저녁, 야근 후 야식, 그리고 주말을 앞둔 금요일의 회식·술자리까지 — 지금 이 시간에 딱 맞는 메뉴와 장소를 서울 지역구별로 추천합니다.',
  ...
  en: {
    title: 'About Bboggl',
    body: [
      'Bboggl helps busy professionals figure out what to eat, right now. From lunch to after-work dinner, late-night bites after overtime, and Friday team dinners before the weekend — we recommend the right spot for the right moment, organized by Seoul district.',
      'Beyond recommendations, Bboggl lets you keep a private archive of places you have actually visited. Like sharing a playlist, you can share a curated list of your favorite spots with friends through a single private link.',
